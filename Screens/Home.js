...
class Home extends Component{
    ...
    render() {
        ...
        this.props.name.all.value1 === this.sliderOptions[currentItem].value;
        console.log("hope :" +  this.props.name.all.value1);
        return <View style={styles.container}>
            ...
            <View style={{bottom:40}}>
                <View style={{top:5}}>
                <TouchableHighlight
                    onPress={() => this.props.navigation.navigate('two' , {itemId: itemArray})}
